import{f as o,a as i}from"../chunks/CIeusH0s.js";import"../chunks/Ci9upTKH.js";var n=o(`<section class="relative overflow-hidden pt-32 pb-20 lg:pt-48 lg:pb-32"><div class="mb-12 text-center"><span class="text-evim-green text-sm font-semibold tracking-wider uppercase">Aktualności</span> <h2 class="text-evim-dark mt-2 text-3xl font-bold text-pretty">KLAUZULA INFORMACYJNA (RODO)</h2></div> <div class="m-auto mb-12 max-w-3xl p-5 text-justify text-balance text-gray-600"><p class="mt-4">Administratorem danych osobowych pozyskanych i przetwarzanych w związku z zawarciem i
			...
			wykonywana.</p></div></section>`);function w(a){var e=n();i(a,e)}export{w as component};
